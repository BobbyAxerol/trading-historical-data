"""Reader-side storage release-manifest and compatibility contract.

This top-level module is included in the reader wheel.  Collector code imports
the same implementation through ``collectors.common.storage_manifest`` so a
writer and an installed consumer cannot drift onto different contract rules.
"""
