#!/usr/bin/env bash
# Launch exactly the reviewed, detached Phase D BTCUSDT quarterly rebuild.
set -euo pipefail
...
hmd_service="phase-d-binance-usdm-quarterly-1m"
...
exec sudo -n env \
  ...
  PRIMUS_HMD_PHASE_D_BINANCE_USDM_QUARTERLY_1M_APPROVED=approved \
  docker compose \
